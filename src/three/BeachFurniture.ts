...
export class BeachFurniture {
  ...
  public createBeachChair(position: THREE.Vector3, rotation: number = 0): void {
    ...
    // Seat fabric
    const seatFabric = new THREE.Mesh(
    ...
    // Back fabric
    const backFabric = new THREE.Mesh(
      new THREE.PlaneGeometry(1.1, 0.7),
      fabricMaterial
    );
  ...
  public createUmbrella(position: THREE.Vector3, rotation: number = 0): void {
